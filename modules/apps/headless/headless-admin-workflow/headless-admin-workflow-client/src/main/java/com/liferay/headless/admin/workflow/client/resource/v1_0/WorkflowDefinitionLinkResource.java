...
public interface WorkflowDefinitionLinkResource {
	...
	public HttpInvoker.HttpResponse getWorkflowDefinitionLinksPageHttpResponse(
			Pagination pagination)
		throws Exception;
	...
	public void postWorkflowDefinitionLinksPageExportBatch(
			String callbackURL, String contentType, String fieldNames)
		throws Exception;

	public HttpInvoker.HttpResponse
			postWorkflowDefinitionLinksPageExportBatchHttpResponse(
				String callbackURL, String contentType, String fieldNames)
		throws Exception;
	...
	public static class WorkflowDefinitionLinkResourceImpl
		...
		public Page<WorkflowDefinitionLink> getWorkflowDefinitionLinksPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getWorkflowDefinitionLinksPageHttpResponse(pagination);
		...
		public HttpInvoker.HttpResponse
				getWorkflowDefinitionLinksPageHttpResponse(
					Pagination pagination)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-workflow/v1.0/workflow-definition-links");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-admin-workflow/v1.0/workflow-definition-links/export-batch");
...
// LIFERAY-REST-BUILDER-HASH:-1170050012