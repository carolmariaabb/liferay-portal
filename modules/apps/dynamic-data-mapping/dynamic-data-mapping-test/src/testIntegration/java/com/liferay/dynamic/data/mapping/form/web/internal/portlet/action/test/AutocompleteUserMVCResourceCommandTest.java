...
public class AutocompleteUserMVCResourceCommandTest {
	...
	@Test
	public void testServeResponse1() throws Exception {
		...
		JSONArray jsonArray = _getUsersJSONArray(user);
	...
	@Test
	public void testServeResponse2() throws Exception {
		User user = UserTestUtil.addUser();
	...
	public void testServeResponseWithCompanyAdmin() throws Exception {
		...
		JSONArray jsonArray = _getUsersJSONArray(TestPropsValues.getUser());
	...
	public void testServeResponseWithError() throws Exception {
		MockLiferayResourceRequest mockLiferayResourceRequest =
			_getMockLiferayResourceRequest(TestPropsValues.getUser(), false);
	...
	private JSONArray _getUsersJSONArray(User user) throws Exception {
		MockLiferayResourceResponse mockLiferayResourceResponse =
			new MockLiferayResourceResponse();

		_mvcResourceCommand.serveResource(
			_getMockLiferayResourceRequest(user, true),
