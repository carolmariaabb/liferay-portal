...
public class DocumentLibraryDDMFormFieldTemplateContextContributor
	...
	public Map<String, Object> getParameters(
		...
		parameters.put(
			...
			GetterUtil.getBoolean(
				ddmFormFieldRenderingContext.getProperty("allowGuestUsers")));
		parameters.put(
	...
	protected String getUploadURL(
		...
		portletURL.setParameter(ActionRequest.ACTION_NAME, "uploadFileEntry");
		...
		portletURL.setParameter(
			"userId",
			String.valueOf(ddmFormFieldRenderingContext.getProperty("userId")));
