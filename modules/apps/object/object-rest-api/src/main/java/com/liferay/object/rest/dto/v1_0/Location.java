...
public class Location implements Serializable {
	...
	public Coordinates getCoordinates() {
		if (_coordinatesSupplier != null) {
			coordinates = _coordinatesSupplier.get();

			_coordinatesSupplier = null;
		}
	...
	public void setCoordinates(
		UnsafeSupplier<Coordinates, Exception> coordinatesUnsafeSupplier) {

		_coordinatesSupplier = () -> {
			try {
				return coordinatesUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<Coordinates> _coordinatesSupplier;
	...
	public String toString() {
		...
		if (coordinates != null) {
			...
			sb.append(String.valueOf(coordinates));
		}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.object.rest.dto.v1_0.Location",
		name = "x-class-name"
	)
