...
public class UserLocalServiceImpl extends UserLocalServiceBaseImpl {
	...
	public User getOrAddEmptyUser(
		...
		return EmptyModelManagerUtil.getOrAddEmptyModel(
			...
			this::fetchUserByExternalReferenceCode,
			this::getUserByExternalReferenceCode,
			() -> _addEmptyUser(
	...
	public User updateUser(
		...
		user.setStatus(
			EmptyModelManagerUtil.solveEmptyModel(
				user.getExternalReferenceCode(), user.getModelClassName(),
				user.getCompanyId(), 0, user.getStatus(),
	...
	private User _addEmptyUser(
		...
		User user = addUser(
			creatorUserId, companyId, true, null, null, autoScreenName,
			screenName, emailAddress, LocaleUtil.getDefault(),
			"Autogenerated", StringPool.BLANK, "User", 0, 0, true,
			Calendar.JANUARY, 1, 1970, StringPool.BLANK,
			UserConstants.TYPE_REGULAR, null, null, null, null, false,
			new ServiceContext());

		user.setExternalReferenceCode(externalReferenceCode);
		user.setStatus(WorkflowConstants.STATUS_EMPTY);
